    ...
    try {
        ...
        switch ($page) {
            ...
            case 'manage-wise-navigations':
                $target_table = $t_wise_navigations;
                $search_field = 'registered_sentence_id';
                $search_value = intval(fetch_registered_sentence_id_from_unique_code($unique_code, $int_selected_language));
                break;

            case 'manage-wise-navigation-waypoints':
                $target_table = $t_wise_navigation_waypoints;
                $search_field = 'wise_navigation_id';
                $search_value = intval(fetch_wise_navigation_id_from_unique_code($unique_code, $int_selected_language));
                break;

            case 'manage-wise-navigation-scripts':
                $target_table = $t_wise_navigation_scripts;
                $search_field = 'wise_navigation_waypoint_id';
                $search_value = intval(fetch_wise_navigation_waypoint_id_from_unique_code($unique_code, $int_selected_language));
                break;

            case 'manage-wise-navigation-items':
                $target_table = $t_wise_navigation_items;
                $search_field = 'wise_navigation_script_id';
                $search_value = intval(fetch_wise_navigation_script_id_from_unique_code($unique_code, $int_selected_language));
                break;
